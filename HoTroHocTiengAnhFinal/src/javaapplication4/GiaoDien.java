...
//    }
    ...
    public void giaodien1() {
        ...
        frm.setLocationRelativeTo(null);// xuat hien o giua man hinh  
         FrameDragListener frameDragListener = new FrameDragListener(frm);
                frm.addMouseListener(frameDragListener);
          frm.addMouseMotionListener(frameDragListener);
